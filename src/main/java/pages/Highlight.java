...
//    WebElement clip3;
    ...
    @FindBy(xpath = "//div[@class='_navItem_1n7md_4 _active_1n7md_14 ']")
    WebElement previewButton;
    @FindBy(xpath = "(//p[contains(@class,'_aspectRatioLabel_qv7pu_9')])[1]")
    WebElement frame;
